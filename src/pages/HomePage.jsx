...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-purple-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/library" className="text-gray-300 hover:text-purple-400 transition-colors">
                Library
              </Link>
              <Link to="/upload" className="text-gray-300 hover:text-purple-400 transition-colors">
                Upload
              </Link>
              <Link to="/profile" className="text-gray-300 hover:text-purple-400 transition-colors">
                Profile
              </Link>
      ...
      <section id="library-showcase" className="py-16 px-4 sm:px-6 lg:px-8">
